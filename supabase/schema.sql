...
create index if not exists idx_product_ingredients_stock_item_product on product_ingredients(stock_item_id, product_id);
...
create index if not exists idx_main_stock_item_branch_type on main_stock(stock_item_id, branch_id, type);
create index if not exists idx_main_stock_source_reference_type on main_stock(source, reference_id, type);
create index if not exists idx_main_stock_branch_created_at on main_stock(branch_id, created_at desc);
...
create index if not exists idx_stock_requests_user_status_date_branch on stock_requests(user_id, status, date, branch_id);
create index if not exists idx_stock_requests_branch_status_created_at on stock_requests(branch_id, status, created_at desc);
create index if not exists idx_stock_request_items_request_stock on stock_request_items(request_id, stock_item_id);
create index if not exists idx_stock_request_items_stock_request on stock_request_items(stock_item_id, request_id);
create index if not exists idx_transactions_branch on transactions(branch_id);
create index if not exists idx_transactions_created_at on transactions(created_at desc);
create index if not exists idx_transactions_branch_created_at on transactions(branch_id, created_at desc);
create index if not exists idx_transactions_created_by_created_at on transactions(created_by, created_at desc);
create index if not exists idx_transactions_source_user_created_at on transactions(source_user_id, created_at desc);
...
create index if not exists idx_dining_tables_branch_status on dining_tables(branch_id, status);
...
create index if not exists idx_customer_orders_code on customer_orders(order_code);
create index if not exists idx_customer_orders_table_status_payment on customer_orders(table_id, status, payment_status);
create index if not exists idx_customer_orders_branch_status_created_at on customer_orders(branch_id, status, created_at desc);
create index if not exists idx_customer_orders_transaction_id on customer_orders(transaction_id);
...
create index if not exists idx_customer_order_item_reviews_order_id on customer_order_item_reviews(order_id);
create index if not exists idx_customer_order_item_reviews_product_id on customer_order_item_reviews(product_id);
